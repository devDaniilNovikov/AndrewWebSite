...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `task-session-handoff` | 0 | Codex | `origin/main` | `draft_pr` | `task-session-handoff` | `/Users/daniilnovikov/.codex/worktrees/session-handoff/AndrewWorkWebSite` | [PR #17](https://github.com/devDaniilNovikov/AndrewWorkWebSite/pull/17) | Markdown, relative links, secrets, diff, independent specification review; CI pending | Authorized for squash merge after green gates |
