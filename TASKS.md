...
| 4 | `fix-preserve-merged-branches` | 1 | Codex | `task-backend-skeleton` merged | `ready` | `fix-preserve-merged-branches` | `/Users/daniilnovikov/.codex/worktrees/preserve-merged-branches/AndrewWorkWebSite` | [PR #19](https://github.com/devDaniilNovikov/AndrewWebSite/pull/19) | GitHub auto-delete disabled; skeleton branch restored; docs, links, secrets, and independent review clean; fresh PR CI and Semgrep green; PR relay intentionally skipped | Authorized after this ready metadata commit also has fresh green PR gates; post-merge `main` gates must also be verified |
