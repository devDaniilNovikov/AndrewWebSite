...
| 3 | `task-backend-skeleton` | 1 | Codex | `task-backend-contract-plans` merged | `draft_pr` | `task-backend-skeleton` | `/Users/daniilnovikov/.codex/worktrees/backend-skeleton/AndrewWorkWebSite` | [PR #18](https://github.com/devDaniilNovikov/AndrewWorkWebSite/pull/18) | Maven 3.9.16; 15 tests; verify/dependency tree green; JaCoCo 94.74%; runtime profiles/health/Actuator, checksums, diff, scope, secrets, specification, quality/security, and whole-branch review green; CI pending | Not authorized; stop at Ready |
