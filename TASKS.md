...
| 2 | `task-backend-contract-plans` | 0 | Codex | `task-session-handoff` merged | `ready` | `task-backend-contract-plans` | `/Users/daniilnovikov/.codex/worktrees/backend-contract-plans/AndrewWorkWebSite` | [PR #15](https://github.com/devDaniilNovikov/AndrewWorkWebSite/pull/15) | Synced; specification, quality/security, whole-branch review, controller checks, and required CI green (verify live before merge) | Authorized for squash merge while live required gates remain green |
