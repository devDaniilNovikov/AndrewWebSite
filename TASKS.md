...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `task-session-handoff` | 0 | Codex | `origin/main` | `ready` | `task-session-handoff` | `/Users/daniilnovikov/.codex/worktrees/session-handoff/AndrewWorkWebSite` | [PR #17](https://github.com/devDaniilNovikov/AndrewWorkWebSite/pull/17) | Markdown, relative links, secrets, diff, independent specification and whole-branch review; required CI green on prior head, refresh pending for this metadata commit | Authorized for squash merge after refreshed green gates |
| 2 | `task-backend-contract-plans` | 0 | Codex | `task-session-handoff` merged | `ready` | `task-backend-contract-plans` | `/Users/daniilnovikov/.codex/worktrees/backend-contract-plans/AndrewWorkWebSite` | [PR #15](https://github.com/devDaniilNovikov/AndrewWorkWebSite/pull/15) | Live current head is reviewed and CI green; the separately authorized correction cycle must return the PR to Draft and establish fresh evidence before merge | Authorized for squash merge only after the correction cycle and refreshed green gates |
