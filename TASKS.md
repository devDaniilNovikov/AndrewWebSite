...
| 4 | `fix-preserve-merged-branches` | 1 | Codex | `task-backend-skeleton` merged | `draft_pr` | `fix-preserve-merged-branches` | `/Users/daniilnovikov/.codex/worktrees/preserve-merged-branches/AndrewWorkWebSite` | [PR #19](https://github.com/devDaniilNovikov/AndrewWebSite/pull/19) | GitHub auto-delete disabled; skeleton branch restored; docs, links, secrets, and independent review clean; fresh PR CI pending | Authorized after fresh green PR gates; post-merge `main` gates must also be verified |
