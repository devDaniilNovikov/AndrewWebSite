...
| 7 | `task-ci-backend-gates` | 1 | Jules | `fix-backend-skeleton-review` explicitly merged; follow-on owner reconciled `TASKS.md`; separately authorized Jules dispatch | `in_progress` | `task-ci-backend-gates` | `/Users/daniilnovikov/.codex/worktrees/ci-backend-gates/AndrewWorkWebSite` | Owner-authored Issue and Jules PR pending dispatch | Live prerequisites and Jules automation gates verified; implementation checks pending | Dispatch explicitly authorized on 2026-07-18; merge is not authorized |
