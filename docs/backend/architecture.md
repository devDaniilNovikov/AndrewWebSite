...
| Temurin 25 CI, verify, 80% coverage, Testcontainers runtime, OWASP Dependency-Check at CVSS 7.0, Java security gate, sanitized owner Issue trigger | `task-ci-backend-gates` | backend foundation Task 2 |
