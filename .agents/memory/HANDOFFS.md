...
| --- | --- | --- | --- |
| `fix-sec-05-retention-skip-locked-heartbeat` | `2026-07-27-060528-fix-sec-05-retention-skip-locked-heartbeat-handoff.md` | fresh branch from merged SEC-04; controlled lock-contention RED next | backend, privacy, security, tracker |
