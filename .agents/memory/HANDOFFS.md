...
| --- | --- | --- | --- |
| `fix-ci-timeouts-annotations` | `2026-07-19-194032-fix-ci-timeouts-annotations-handoff` → `2026-07-19-195143-fix-ci-timeouts-annotations-ready-handoff` | ready; merge requires explicit user authorization | ci, process |
