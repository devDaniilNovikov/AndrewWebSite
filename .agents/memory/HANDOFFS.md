...
| --- | --- | --- | --- |
| `fix-frontend-track-gaps` | `2026-07-20-072812-fix-frontend-track-gaps-handoff` | draft PR; proposed contracts await approval | frontend, product, ci, tracker, memory |
