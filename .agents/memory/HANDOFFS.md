...
| `task-telegram-client` | `2026-07-25-193657-task-telegram-client-handoff.md` → `2026-07-25-202007-task-telegram-client-handoff.md` → `2026-07-25-210328-task-telegram-client-handoff.md` | `in_progress` | backend, security |
